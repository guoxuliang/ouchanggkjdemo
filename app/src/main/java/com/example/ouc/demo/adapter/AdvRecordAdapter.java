...
public class AdvRecordAdapter extends BaseAdapter{
private Context context;
private List<AdvRecordEntity.DataBean> orderList;
    private  String name_str;
    private  String jlj_str;
    private  String syrw_str;
    private  String je_str;
    private LayoutInflater inflater;
    public AdvRecordAdapter(Context context, List<AdvRecordEntity.DataBean> orderList) {
            ...
            for (int j=0; j<orderList.size();j++){
                ...
                jlj_str= String.valueOf(orderList.get(i).getGold());
                 syrw_str= String.valueOf(orderList.get(i).getQuantity());
                  je_str= String.valueOf(orderList.get(i).getWatchtime());
