...
public class MyOnScrollListener implements AbsListView.OnScrollListener {
    ...
    private void loadMoreData() {
        isLoading = true;
        RecommendedListEntity.DataBean listEntity = null;
        data = new ArrayList<>();
//        for (int i = 0; i < 10; i++) {
//            listEntity = new RecommendedListEntity.DataBean();
//            listEntity.getId();
//            listEntity.getCover();
//            listEntity.getTitle();
//            listEntity.getBrowsevolume();
//            listEntity.getQuantity();
//            listEntity.getGold();
//            listEntity.getVideo();
//            data.add(listEntity);
//        }
...
//            ToastHelper.show(getActivity(), "暂无数据");
    ...
    public interface OnloadDataListener {
        void onLoadData(List<RecommendedListEntity.DataBean> data);
    }
}
