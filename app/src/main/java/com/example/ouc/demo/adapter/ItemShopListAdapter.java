...
public class ItemShopListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private ArrayList<ShoppingqueryListEntity.DataBean> datas;
    ...
    public ItemShopListAdapter(ArrayList<ShoppingqueryListEntity.DataBean> datas, Context context, boolean hasMore) {
        this.datas = datas;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == normalType) {
            return new NormalHolder(LayoutInflater.from(context).inflate(R.layout.itemshoplist, null));
        } else {
...
//            ((NormalHolder) holder).tv_jlijin.setText("奖励金：￥" + datas.get(position).getGold());
    ...
    public void updateList(ArrayList<ShoppingqueryListEntity.DataBean> newDatas, boolean hasMore) {
        if (newDatas != null) {
