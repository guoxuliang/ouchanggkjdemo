...
public class AddressEntity {
    ...
    private List<GetShoppingCartEntity.DataBean> data;
    ...
    public List<GetShoppingCartEntity.DataBean> getData() {
        return data;
    }

    public void setData(List<GetShoppingCartEntity.DataBean> data) {
        this.data = data;
    }
